...
const getSellersId = (companyId: string): { [key: number]: string } => {
  if (companyId === "1") {
    return {
      ...
      23: "62979ff880d64c000d8f7db9", // JULIO
      25: "63e11f55c8e5ba000c5de3b2", // JOAO VITOR
      26: "661fc4d0404309000f32e6ff", // BEATRIZ
      27: "6683d60e6a652a000fae8214", // SHEILA
      29: "677d45689f124d001b14805d", // HENRIQUE
      31: "689e12b01812e90014a3ec8a", // BRENDA
